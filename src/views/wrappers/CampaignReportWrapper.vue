...
const engineComponents: Record<EngineType, ReturnType<typeof defineAsyncComponent>> = {
  aggrid: defineAsyncComponent(() => import('../aggrid/CampaignReport.vue')),
  tabulator: defineAsyncComponent(() => import('../tabulator/CampaignReport.vue')),
  primevue: defineAsyncComponent(() => import('../primevue/CampaignReport.vue')),
}
</script>
